              ...
              <div class="col-lg-6 bg-login-image-BTD" >
                <div class="p-5">
                  ...
                  <form id="form1" runat="server" class="user">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="TextBoxPassword" placeholder="Password" CssClass="form-control form-control-user" runat="server"></asp:TextBox>
                    
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                          <asp:Label ID="LabelError" runat="server" CssClass="text" Text=""></asp:Label>
                      </div>
                    </div>
